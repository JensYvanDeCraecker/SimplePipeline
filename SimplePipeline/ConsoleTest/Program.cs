...
namespace ConsoleTest
{
    internal class Program
    {
        private static void Main()
        {
            ...
            IPipeline<String, Byte[]> demoPipeline = PipelineBuilder.Chain(new TrimFilter()).Chain(((Func<String, Byte[]>)(input => Encoding.Unicode.GetBytes(input))).ToFilter()).Chain(new HashingFilter()).Build();
